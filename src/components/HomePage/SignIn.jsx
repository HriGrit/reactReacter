        ...
        <>
            <div>
                ...
                <div className='hidden es:max-sm:block'>
                    <div>
                        <img className='fixed top-[54%] left-[87.3%] w-fit h-fit items-center justify-center z-50 text-black cursor-pointer' onClick={closeAccount} src={vector} alt="cancel"></img>
                    </div>
                    <div className='flex flex-col'>
