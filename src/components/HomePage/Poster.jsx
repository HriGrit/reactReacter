...
const Poster = () => {
  return (
    <>
      ...
      >
        <div className="pl-[13.8%] pt-[286px] text-white text-4xl font-bold font-['IBM Plex Sans']">
          Computer Engineering
        </div>
        <div className="pl-[13.8%] text-white text-lg font-normal font-['IBM Plex Sans']">
