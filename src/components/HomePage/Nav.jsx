    ...
    return (
        <div className='flex flex-row'>
            <div className="w-[358px] h-[21px] relative left-[13.8%] mt-[47px]">
                ...
                <div className="hidden sm:block Education left-[239px] top-0 absolute text-zinc-500 text-base font-normal font-['IBM Plex Sans']">Education</div>
                <div className="hidden sm:block Job left-[331px] top-0 absolute text-zinc-500 text-base font-normal font-['IBM Plex Sans']">Job</div>
            </div>

            <div className="flex justify-end w-full relative right-[13.8%] mt-[40px] items-center">
                <div className="w-[133px] h-9 relative mr-[16px]">
                    <div className="w-[133px] h-9 left-0 top-0 absolute bg-gray-100 rounded" />
                    <div className="WriteAPost left-[12px] top-[8px] absolute text-black text-[15px] font-medium font-['IBM Plex Sans']">Write a Post</div>
                ...
                <div className="Rectangle4 w-[125px] h-9 bg-blue-600 rounded flex flex-row">
                    ...
                    <div className="JoinGroup text-white text-[15px] font-medium font-['IBM Plex Sans'] my-[7px]">Join Group</div>
                </div>
            </div>
        </div>
    )
